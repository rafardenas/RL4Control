...
class ObservationSpace(object):
    def __init__(self, shape):
        ...
        #self.state_0 = np.random.randint(0,1, shape, dtype=np.int32)
        #self.state_1 = np.random.randint(1,2, shape, dtype=np.int32)
        #self.state_2 = np.random.randint(2,3, shape, dtype=np.int32)
        #self.state_3 = np.random.randint(3,4, shape, dtype=np.int32)

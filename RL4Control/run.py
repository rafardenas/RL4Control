...
xi_ = np.array([0.25])                             # Epsilon greedy definition (from experiment)
...
MrQ                 = Q_Learning(steps_, num_actions, modulus, state_UB, lr = 1, disc1 = 0.85, disc2 = 0.95)                 # calling agent
#agent.printd((1.0, 80.0, 10.0))
experiment          = Experiment(env, MrQ, controls, episodes_train, xi_)  # calling training experiment
